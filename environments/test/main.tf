...
module "main" {
  ...
  comfyui_instance_type       = "g4dn.xlarge"
  ...
  # 2) End trial and delete infra: terraform -chdir=environments/test destroy
  # 3) Verify no leftovers in AWS billing console (EBS snapshots, extra volumes, EIPs)
