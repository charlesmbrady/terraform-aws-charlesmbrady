...
data "aws_iam_policy_document" "agentcore_runtime_policy" {
  ...
  statement {
    ...
    # Use * for CreateLogGroup and broader wildcard for streams since the full
    # group name (including runtime id) is generated by the service.
    resources = [
      "arn:aws:logs:${var.region}:${var.account_id}:log-group:/aws/bedrock-agentcore/runtimes*",
      "arn:aws:logs:${var.region}:${var.account_id}:log-group:/aws/bedrock-agentcore/runtimes*:log-stream:*"
    ]
  }
